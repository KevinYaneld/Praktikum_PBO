...
public class main {
    ...
    public static void readPasien() throws IOException{
        ...
        for (int i = 0; i < pasien.size(); i++) {
            ...
            System.out.println("    Nama Pasien : " + pasien.get(i).nama);
            System.out.println("    Jenis Kelamin : " + pasien.get(i).jenis_kelamin);
            System.out.println("    Umur : " + pasien.get(i).umur);
            System.out.println("    Alamat : " + pasien.get(i).alamat);
            System.out.println("    Keluhan : " + pasien.get(i).keluhan);
            System.out.print("\n");
        }
    }
    ...
    public static void updatePasien() throws IOException{
        ...
        pasien.get(index-1).nama = updateNama;
        pasien.get(index-1).jenis_kelamin = updateJenis;
        pasien.get(index-1).umur = updateUmur;
        pasien.get(index-1).alamat = updateAlamat;
        pasien.get(index-1).keluhan = updateKeluhan;        
