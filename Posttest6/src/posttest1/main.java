...
public class main {
    ...
    static final int CREATE_DATA_OPTION = 1;
    static final int READ_DATA_OPTION = 2;
    static final int UPDATE_DATA_OPTION = 3;
    static final int DELETE_DATA_OPTION = 4;
    static final int EXIT_OPTION = 5;
    static final int DATA_DOKTER_OPTION = 2;
    static final int DATA_PASIEN_OPTION = 1;
    ...
    while (true) {
            ...
            switch (pilihan) {
                case CREATE_DATA_OPTION:
                    createData();
                    break;
                case READ_DATA_OPTION:
                    System.out.println("============================");
                    ...
                    switch (pilih) {
                    case DATA_PASIEN_OPTION -> readData();
                    case DATA_DOKTER_OPTION -> readDataDokter();
                    default -> System.out.println("Pilihan Tidak Tersedia");
                    }
                    break;
                case UPDATE_DATA_OPTION:
                    updateData();
                    break;
                case DELETE_DATA_OPTION:
                    deleteData();
                    break;
                case EXIT_OPTION:
                    System.exit(0);
...
//                Fungsi Overloading
    ...
    public static void deleteData() throws IOException{
        ...
        System.out.print("Masukan Pilihan Anda: ");
        int pilih = Integer.parseInt(br.readLine());
        if (pilih == DATA_PASIEN_OPTION){
            readData();
            System.out.println("DELETE DATA PASIEN");
            System.out.print("Masukan Data Pasien ke-");
            int index = Integer.parseInt(br.readLine());
            pasien.remove(index-1);
        }else if(pilih == DATA_DOKTER_OPTION){
            readDataDokter();
