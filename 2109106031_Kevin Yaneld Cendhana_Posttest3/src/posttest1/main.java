    ...
    public static void createData() throws IOException{
        ...
        switch (pilih) {
            ...
            case 2 -> {
                ...
                System.out.print("\n");
                Dokter dokterBaru = new Dokter(addNamaDokter, addJenisDokter, addUmurDokter, addAlamatDokter, addSpesialis);
                
                dokter.add(dokterBaru);

                dokterBaru.terdata_dokter();
            }
            default -> System.out.println("Pilihan Tidak Tersedia");
        }
    ...
    public static void updateData() throws IOException{
        ...
        switch (pilih) {
            ...
            case 2 ->{
                ...
                dokter.get(index-1).update_dokter();
            }
        }
